import { SkillIconsGCPDark } from "./SkillIconsGCPDark";
...
import { SkillIconsElasticsearchDark } from "./SkillIconsElasticsearchDark";
import { SkillIconsJavaDark } from "./SkillIconsJavaDark";
...
import { SkillIconsTailwindcssDark } from "./SkillIconsTailwindcssDark";
...
import {SkillIconsGithubActionsDark} from './SkillIconsGithubActionsDark';


const svg_skills = [
    { name: "GCP", icon: SkillIconsGCPDark },
    ...
    { name: "GH.Actions", icon: SkillIconsGithubActionsDark },
    { name: "Node.js", icon: SkillIconsNodejsDark },
    { name: "Elas.Search", icon: SkillIconsElasticsearchDark },
